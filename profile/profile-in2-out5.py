...
planFilePath   = "../"
encoderPlanFile  = planFilePath + "encoder_fix_for_pass.plan"
encoderScoreFile = planFilePath + "log/encoder_fix_for_pass_Score.txt"
decoderPlanFile  = planFilePath + "decoder_fix_for_pass.plan"
decoderScoreFile = planFilePath + "log/decoder_fix_for_pass_Score.txt"
